        ...
        >
          <Box>
            <Typography style={{ fontWeight: "bold" }} gutterBottom>
              <p className="text-base text-[#42424a] font-semibold mr-2">Appointment Category</p>
            </Typography>
          </Box>
            ...
            >
              <Box>
                <p className="flex flex-row text-xs items-center">
                  Appointment Category:<span className="text-red-600 text-base mx-2">*</span>
                </p>
          ...
          <Box sx={{ marginTop: 1 }}>
            <Typography style={{ fontWeight: "bold" }} gutterBottom>
              <p className="text-base text-[#42424a] font-semibold mr-2">Appointment Categories</p>
            </Typography>
          </Box>
