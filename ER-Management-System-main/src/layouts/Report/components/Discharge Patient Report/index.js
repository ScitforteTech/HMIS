...
function DischargePatientReport() {
    ...
    <>
      <Box>
        <Typography style={{ fontWeight: "bold" }} gutterBottom>
          <p className="text-base text-[#42424a] font-semibold mr-2">Dischare Patient Report</p>
        </Typography>
      </Box>
      ...
      <Grid container sx={{ marginTop: 1 }} spacing={2} className="flex items-end">
        ...
        >
          <div>
            {/* Label */}
            <p htmlFor="dischargeType" className="text-xs mb-2">
              Discharge Type:
            </p>
            ...
            >
              <option value="Select Entitlement">Select Discharge Type</option>
            </select>
          </div>
        </Grid>
      </Grid>
      ...
      <Box>
        <Typography sx={{ marginTop: 1 }} style={{ fontWeight: "bold" }} gutterBottom>
          <p className="text-base text-[#42424a] font-semibold mr-2">
            Searched Discharged Patients Reports
          </p>
        </Typography>
      </Box>
