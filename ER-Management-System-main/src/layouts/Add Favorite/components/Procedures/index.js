...
function FavoriteProcedures() {
  const { columns: ProceduresColumns, rows: ProceduresRows } = ProceduresData();
  ...
  return (
    <>
      ...
      <Grid container spacing={2} sx={{ marginTop: 1 }}>
        <Grid item sm={12}>
          <DataTable
            table={{ columns: ProceduresColumns, rows: ProceduresRows }}
...
export default FavoriteProcedures;
